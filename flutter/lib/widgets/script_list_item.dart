...
class ScriptListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        title: SelectableText(script.title, style: Theme.of(context).textTheme.titleMedium),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            if (script.author != null) SelectableText('Author: ${script.author}'),
            ...
            if (script.createdAt != null)
              SelectableText('Created: ${script.createdAt!.toLocal().toString().split(' ')[0]}'),
          ],
        ),
        trailing: Row(
