      ...
      _analysisResult = AnalysisResult(
        ...
        sceneAssessments: [
          ...
          SceneAssessment(
            ...
            pageRange: '12-15',
            categories: {Category.sexualContent: Severity.moderate},
              ...
              child: Column(
                ...
                children: [
                  ...
                  CategorySummaryWidget(
                    categories: _analysisResult!.ratingResult.categoriesSummary
                        .map(
                          (key, value) => MapEntry(
                            key.name,
                            value.index / Severity.values.length.toDouble(),
                          ),
                        ),
                  ),
                  const SizedBox(height: 24),
                  ...
                  ..._analysisResult!.sceneAssessments.map(
                    (assessment) => SceneDetailWidget(assessment: assessment),
                  ),
                  const SizedBox(height: 24),
                  Center(
